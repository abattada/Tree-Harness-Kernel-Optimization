...
\author{%
\IEEEauthorblockN{[Wei-Ke, Chu]}
\IEEEauthorblockA{{[R13922198]} \\ {[Computer Science and Information Engineering/ National Taiwan University]} \\ abat52875@gmail.com}
\and
\IEEEauthorblockN{[Ju-Hsuan, Wang]}
\IEEEauthorblockA{{[R13945026]} \\ {[Biomedical Electronics and Bioinformatics / National Taiwan University]}}
\and
\IEEEauthorblockN{[Wen-An, Wen]}
\IEEEauthorblockA{{[R13944053]} \\ {[Computer Science and Information Engineering / National Taiwan University]}}%
}
...
\url{https://github.com/abattada/Tree-Harness-Kernel-Optimization}.
\end{abstract}
...
\begin{table}[t]
  ...
  \caption{DeepSeek API loop aggregate. $\text{fast}_p$ is the fraction of
  operators whose best speedup exceeds $p$.}
  \label{tab:ds}
  \begin{tabular}{cccccc}
    \toprule
    Cands & Correct & $\text{fast}_{1.0}$ & $\text{fast}_{1.2}$ &
      GPU-min & Mtokens \\
    \midrule
    222 & 0.74 & 0.71 & 0.43 & 15.4 & 1.52 \\
    \bottomrule
  \end{tabular}
\end{table}
